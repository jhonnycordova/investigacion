...
$diccionario = array('titulos'=>array('registrar'=>'Agregar Nuevo Cargo',
									  'verdatos'=>'Tabla de Cargos',
									  'modificar'=>'Modificar Cargo '));
...
if ($vista=='registrar'){
	$html = str_replace('{contenido}',  buscar_plantilla('registrar','cargos'), $html);
	$html = str_replace('{subtitulo}', $diccionario['titulos'][$vista], $html);

}

if ($vista=='verdatos'){
	$html = str_replace('{contenido}',  buscar_plantilla('verdatos','cargos'), $html);
	$html = str_replace('{subtitulo}', $diccionario['titulos'][$vista], $html);
	$html = llenar_tabla($html, $data);
}

if ($vista=='modificar'){
	$html = str_replace('{contenido}',  buscar_plantilla('modificar','cargos'), $html);
	$html = str_replace('{subtitulo}', $diccionario['titulos'][$vista], $html);
